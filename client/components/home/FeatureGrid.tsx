    ...
    <div className="group relative" onPointerLeave={resetTransform}>
      <div
        ...
        className={cn(
          ...
          "shadow-2xl shadow-brand-500/20 backdrop-blur-2xl transition-transform duration-200 ease-out will-change-transform",
      ...
      >
        <div className="absolute inset-0 opacity-0 transition-opacity duration-200 group-hover:opacity-100">
          <div className="absolute inset-0 bg-gradient-to-br from-brand-500/20 via-brand-400/10 to-transparent" />
          <div className="absolute -left-10 top-1/3 h-36 w-36 rounded-full bg-brand-200/30 blur-3xl dark:bg-brand-600/20" />
        </div>
        ...
        <div className="pointer-events-none absolute inset-x-0 -bottom-16 h-32 translate-y-12 bg-white/10 blur-3xl transition-all duration-300 group-hover:translate-y-6 dark:bg-white/5" />
      </div>
    </div>
  );
}
